...
typedef NS_ENUM(NSUInteger, SobotSSKeychainQuerySynchronizationMode) {
	SobotSSKeychainQuerySynchronizationModeAny,
	SobotSSKeychainQuerySynchronizationModeNo,
	SobotSSKeychainQuerySynchronizationModeYes
};
#endif
 ...
 */
@interface SobotSSKeychainQuery : NSObject
...
@property (nonatomic) SobotSSKeychainQuerySynchronizationMode synchronizationMode;
#endif
