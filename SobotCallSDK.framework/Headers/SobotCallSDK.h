...
//! Project version string for SobotCallSDK.
FOUNDATION_EXPORT const unsigned char SobotCallSDKVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <SobotCallSDK/PublicHeader.h>
