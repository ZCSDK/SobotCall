 ...
 */
@protocol SobotWebSocketDelegate <NSObject>
 ...
 */
-(void)websocketDidConnect:(SobotWebSocket*)socket;
 ...
 */
-(void)websocketDidDisconnect:(SobotWebSocket*)socket error:(NSError*)error;
 ...
 */
-(void)websocket:(SobotWebSocket*)socket didReceiveMessage:(NSString*)string;
 ...
 */
-(void)websocket:(SobotWebSocket*)socket didReceiveData:(NSData*)data;
 ...
 */
-(void)websocketDidWriteError:(SobotWebSocket*)socket error:(NSError*)error;

@end

@interface SobotWebSocket : NSObject

@property(nonatomic,weak)id<SobotWebSocketDelegate>delegate;
